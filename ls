...
[1mDESCRIPTION[0m
       ...
       if none of [1m-cftuvSUX [22mnor [1m--sort [22mis specified.
       ...
       [1m--block-size[22m=[4mSIZE[0m
              with [1m-l[22m, scale sizes by SIZE when printing them; e.g., '--block-size=M'; see SIZE format be‐
              low

       [1m-B[22m, [1m--ignore-backups[0m
              do not list implied entries ending with ~

       [1m-c     [22mwith [1m-lt[22m: sort by, and show, ctime (time of last change of file  status  information);  with
              [1m-l[22m: show ctime and sort by name; otherwise: sort by ctime, newest first
       ...
       [1m--format[22m=[4mWORD[0m
              across,horizontal  ([1m-x[22m),  commas ([1m-m[22m), long ([1m-l[22m), single-column ([1m-1[22m), verbose ([1m-l[22m), vertical
              ([1m-C[22m)
       ...
       [1m--indicator-style[22m=[4mWORD[0m
              append indicator with style WORD to entry  names:  none  (default),  slash  ([1m-p[22m),  file-type
              ([1m--file-type[22m), classify ([1m-F[22m)
       ...
       [1m-k[22m, [1m--kibibytes[0m
              default  to  1024-byte blocks for file system usage; used only with [1m-s [22mand per directory to‐
              tals
       ...
       [1m--sort[22m=[4mWORD[0m
              change default 'name' sort to WORD: none ([1m-U[22m), size ([1m-S[22m), time ([1m-t[22m), version ([1m-v[22m), extension
              ([1m-X[22m), name, width

       [1m--time[22m=[4mWORD[0m
              select which timestamp used to display or sort; access time ([1m-u[22m): atime, access, use;  meta‐
              data  change  time  ([1m-c[22m): ctime, status; modified time (default): mtime, modification; birth
              time: birth, creation;

              with [1m-l[22m, WORD determines which time to show; with [1m--sort[22m=[4mtime[24m, sort by WORD (newest first)
       ...
       [1m-u     [22mwith [1m-lt[22m: sort by, and show, access time; with [1m-l[22m: show access time and sort by name; other‐
              wise: sort by access time, newest first

       [1m-U     [22mdo not sort directory entries
       ...
       K,M,G,T,P,E,Z,Y,R,Q  (powers  of 1024) or KB,MB,... (powers of 1000).  Binary prefixes can be used,
       too: KiB=K, MiB=M, and so on.

       The TIME_STYLE argument can be full-iso, long-iso, iso, locale, or +FORMAT.  FORMAT is  interpreted
       like  in  [1mdate[22m(1).   If FORMAT is FORMAT1<newline>FORMAT2, then FORMAT1 applies to non-recent files
       and FORMAT2 to recent files.  TIME_STYLE prefixed with 'posix-' takes effect only outside the POSIX
       locale.  Also the TIME_STYLE environment variable sets the default style to use.

       The WHEN argument defaults to 'always' and can also be 'auto' or 'never'.

       Using color to distinguish file types is disabled both by default  and  with  [1m--color[22m=[4mnever[24m.   With
       [1m--color[22m=[4mauto[24m,  ls  emits  color  codes  only  when standard output is connected to a terminal.  The
       LS_COLORS environment variable can change the settings.  Use the [1mdircolors[22m(1) command to set it.
...
GNU coreutils 9.9                              November 2025                                         [4mLS[24m(1)
